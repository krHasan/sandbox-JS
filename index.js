$(document).ready(function () {
    ...
    (function () {
        ...
        elements.forEach(function (element) {
            ...
            // #015493 light blue
            let lightBlueArray = ['false', 'true', 'return', 'if', 'else', 'const', 'let', 'var', 'while', 'new', 'async',
                'try', 'await', 'catch', 'success', 'data', 'type', 'dataType', 'name', 'id', 'document', 'undefined',
                'null', 'class', 'table', 'label', 'input', 'tmpl', 'div', 'DOMContentLoaded', 'location'];
            lightBlueArray.forEach(element => {
                text = text.replace(new RegExp("\\b" + element + "\\b", "gi"), '<span style="color: #015493">$&</span>');
            });

            // #C16D27 orange
            let orangeArray = ['require', 'Promise', 'setTimeout', 'resolve', 'get', 'JSON',
                ...
                'getElementById', 'addEventListener', 'createElement', 'appendChild', 'contains', 'valueAsNumber',
                'replace', 'split'];
